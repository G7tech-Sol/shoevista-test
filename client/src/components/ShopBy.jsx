...
const ShopBy = ({ filter, title }) => {
  ...
  const data = [
    { img: "/GenInfo/adidas.jpg", name: "Adidas", to: "/search/adidas" },
    { img: "/GenInfo/nike.png", name: "Nike", to: "/search/nike" },
    { img: "/GenInfo/skechers.jpg", name: "Skechers", to: "/search/skechers" },
    { img: "/GenInfo/puma.jpg", name: "Puma", to: "/search/puma" },
  ];
    ...
    <>
      ...
      <div className="overflow-x-auto overflow-y-hidden md:max-w-full scroll-container mb-10 mx-auto relative scroll-container">
        ...
        <div className="flex flex-nowrap space-x-4">
          ...
          {(filter === "bestSellers" ? (Array.isArray(data) ? data : []) : (Array.isArray(products) ? products : [])).map((elem) => (
            <HorSlider
              product={elem}
